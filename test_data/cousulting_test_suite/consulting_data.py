...
class ConsultingData:
    ...
    information_content = (
        By.XPATH,
        '//android.widget.FrameLayout[2]/android.view.ViewGroup[2]/android.widget.FrameLayout/android.widget.LinearLayout/android.webkit.WebView/android.webkit.WebView/android.view.View[3]/android.view.View')
    ...
    tag_btn = (By.XPATH, '//android.view.View[4]/android.view.View/android.view.View[1]')  # 标签
